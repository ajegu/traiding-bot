...
- [x] Créer le dossier `terraform/bootstrap/`
- [x] Créer `terraform/bootstrap/providers.tf`
- [x] Créer `terraform/bootstrap/variables.tf`
- [x] Créer `terraform/bootstrap/main.tf`
- [x] Créer `terraform/bootstrap/outputs.tf`
- [x] Exécuter `terraform init` dans bootstrap
- [ ] Exécuter `terraform apply` dans bootstrap (à faire manuellement avec AWS credentials)
- [ ] Vérifier la création du bucket S3 dans la console AWS
- [ ] Vérifier la création de la table DynamoDB dans la console AWS
- [x] Créer `terraform/backend.tf`
- [x] Créer `terraform/versions.tf`
- [x] Créer `terraform/providers.tf`
- [x] Créer `terraform/variables.tf`
- [x] Créer `terraform/locals.tf`
- [x] Créer `terraform/outputs.tf`
- [ ] Exécuter `terraform init` dans le dossier principal (après apply du bootstrap)
- [x] Valider avec `terraform validate`
